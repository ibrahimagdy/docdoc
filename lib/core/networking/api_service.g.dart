...
class _ApiService implements ApiService {
  ...
  Future<ForgotPasswordResponseModel> forgotPassword(
    ...
    final _options = _setStreamType<ForgotPasswordResponseModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'Auth/forgetPassword',
  ...
  Future<GetProfilePatientResponse> profilePatient(String token) async {
    ...
    final _options = _setStreamType<GetProfilePatientResponse>(
  ...
  Future<AddProfileImageResponse> uploadProfileImage(
    ...
    final _options = _setStreamType<AddProfileImageResponse>(
      Options(
        method: 'PUT',
        headers: _headers,
        extra: _extra,
  ...
  @override
  Future<SpecializationsResponse> getSpecializations(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<SpecializationsResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'Spcializations',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late SpecializationsResponse _value;
    try {
      _value = SpecializationsResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<RecommendationDoctorsResponse> getRecommendationDoctors(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<RecommendationDoctorsResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'Doctors',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late RecommendationDoctorsResponse _value;
    try {
      _value = RecommendationDoctorsResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
