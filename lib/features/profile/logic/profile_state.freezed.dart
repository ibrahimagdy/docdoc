...
mixin _$ProfileState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(GetProfilePatientResponse profileData) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(GetProfilePatientResponse profileData)? success,
...
abstract class _$$SuccessImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({GetProfilePatientResponse profileData});
}
...
class _$SuccessImpl<T> implements Success<T> {
  const _$SuccessImpl(this.profileData);

  @override
  final GetProfilePatientResponse profileData;

  @override
  String toString() {
    return 'ProfileState<$T>.success(profileData: $profileData)';
  }
...
abstract class Success<T> implements ProfileState<T> {
  const factory Success(final GetProfilePatientResponse profileData) =
      _$SuccessImpl<T>;

  GetProfilePatientResponse get profileData;
...
abstract class Error<T> implements ProfileState<T> {
  const factory Error({required final ApiErrorModel error}) = _$ErrorImpl<T>;
